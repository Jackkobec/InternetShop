                                ...
                                <p><h4><fmt:message key="cart_is_empty" bundle="${rb}"/></h4><p>
                                    ...
                                    <tr>
                                        ...
                                        <form action="Controller" method="POST">
                                            ...
                                            <input type="hidden" name="from_page" value="ITEM_MANAGEMENT_PAGE">
...
<%--GLOBAL BLOCK. ITEM MANAGEMENT FORM--%>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-sm-3 col-md-4">
                                            <form action="Controller?command=edititem" method="POST">
                                                <input type="hidden" name="item_for_edit_id" id="itemForUpdate" value="">
                                    ...
                                    <%----%>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-3 col-md-4">
                                                    <form action="Controller?command=edititem" method="POST">
                                                        <input type="hidden" name="item_for_edit_id" id="itemForCloneId" value=""><%--Поле value пустое т.к. оно сетится через java script смотри описание выше--%>
