    ...
    <div class="row">
        <div class="header">
            <ul>
                ...
                <li>
                    <div class="row"><span class="glyphicon glyphicon-shopping-cart"></div>
        ...
        <div class="col-sm-4">
            <div class="panel panel-danger">
                ...
                <a href="Controller?command=register">
                    <div class="panel-body"><img src="view.components/img/uV4ABsIur2s.png?text=IMAGE"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="carousel carousel-showmanymoveone slide" id="itemslider">
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <a href="#"><img src="view.components/img/uV4ABsIur2s.png"
                                             class="img-responsive center-block"></a>
