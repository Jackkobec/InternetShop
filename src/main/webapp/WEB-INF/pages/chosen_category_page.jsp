                            ...
                            <div class="col-item">
                                ...
                                <c:forEach var="ratingStar" begin="${item.itemRating}" end="4">
                                    ...
                                    <div class="separator clear-left">
                                        <p class="btn-add">
                                            <i class="fa fa-shopping-cart"></i><a href="Controller?command=showitem&item_id=${item.id}" class="hidden-sm">Add to cart</a></p>
                                        <p class="btn-details">
                                            <i class="fa fa-list"></i><a href="Controller?command=showitem&item_id=${item.id}" class="hidden-sm">More details</a></p>
                                    </div>
                                    <div class="clearfix">
                                    </div>
                                </div>
